...
## Project Structure
    ...
    ├── mechanixonsite_35880  # Django project configurations
...
1. Clone this repo and `cd mechanixonsite_35880`
...
2. Clone this repo and `cd mechanixonsite_35880`
